      ...
      <div className="min-h-screen bg-slate-50 py-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Alert className="rounded-2xl border-red-200 bg-red-50">
            <AlertDescription className="text-red-700">Event not found</AlertDescription>
          </Alert>
        </div>
      </div>
    )
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <Input
                  ...
                  className="rounded-2xl"
                />
                <p className="text-sm text-slate-500 mt-1">Upload a new image to replace the current one</p>
              </div>
